            ...
            {properties.map((property) => {
              ...
              return (
                <Link
                  ...
                  className="flex items-center justify-between bg-white rounded-2xl border border-warm-300/50 p-5 hover:border-brand/30 hover:shadow-sm transition-all group"
                >
