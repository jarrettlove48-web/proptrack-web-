...
import { User, Mail, Phone, Shield, Sun, Moon, Pencil, Check, ExternalLink, ArrowUpRight } from "lucide-react";

export default function AccountPage() {
  const supabase = createClient();
  const { profile, refreshProfile, isDark, toggleDarkMode } = useDashboard();
